	jQuery(document).ready(function($){
		...
		var myACFextension = acf.model.extend ({
			events: {
				...
				'change [data-key="field_5e1fbdcc18809"] .acf-input input': '_relationship_change',
			},
			...
			_relationship_change: function(e) {
				...
				// clear input field
				// data-key == field key of date field
				$('[data-key="field_5e209e39e8783"] date').val('');
				
				// clear textarea field
				// date-key == field key of location field
				$('[data-key="field_5e209e79e8785"] text').val('');
                ...
                var ajaxData = {
                    action: 'load_features_from_term',
                    term_id: $ value,
                    post_id: my_acf_extension_object.post_id
                  }
				...
				this.request = $.ajax({
					...
					success: function(json){
						...
						if (json['title']) {
							...
							$('[data-key="field_5e209e39e8783"] input').val(json['title']);
						}
						if (json['excerpt']) {
